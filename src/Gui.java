...
public class Gui {
    ...
    public void gui() {
        ...
        this.frame.getContentPane().setBackground(new Color(223,235,245));
...
//backgroudcollor set to rgb(223, 235, 245)
    ...
    public void makelist(ArrayList<Pojo> g) {
        ...
        for (int i = 0; i < g.size(); i++) {
            ...
            t1.add(boxxs[i]);
            boxxs[i].addItemListener(new Gui.MyItemListener());
        ...
        buttoninvoer.addActionListener(new Gui.UItvoerButtonActionListener());
        t1.add(buttoninvoer);
        t1.add(buttoninpunt);
        frame.add(t1);
        frame.setVisible(true);
